...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    //document.body.classList.add('foto1');
    document.getElementById('noBtn').style.display = 'none';

    // Mostrar el mensaje específico
    document.getElementById('messageContainer').style.display = 'block';
    document.getElementById('messageContainer').innerHTML = '¡Ya sabia que diriás que sip, mi amor, te súper amo mi vida';
    ...
    setTimeout(function() {
        ...
        document.getElementById('happyGifContainer100').style.display = 'block';
    }, 7000);
